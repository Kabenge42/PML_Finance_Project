create view vw_features_cashflow
...
FROM vw_identifier_columns id
         LEFT JOIN calc_cashflow_features() cf(isin, cfo_to_net_income, fcf_to_net_income, fcf_margin, cfo_growth_yoy,
                   ...
                   USING (isin)
         LEFT JOIN calc_enhanced_cashflow_features() ecf(isin, fcf_positive_years, fcf_always_positive, capex_vs_5y_avg,
                                                         underinvestment_flag, cfo_share_of_cf, cfi_share_of_cf,
                                                         cff_share_of_cf, self_funding_flag, acquisition_to_fcf,
                                                         ...
                                                         organic_vs_inorganic, investment_efficiency) USING (isin)
         LEFT JOIN calc_cashflow_temporal_features() ctf(isin, cfo_quarterly_trend, cfo_yoy_quarterly,
                                                         ...
                                                         operating_cf_momentum, financing_dependency) USING (isin)
...
alter table vw_features_cashflow
    owner to postgres;
