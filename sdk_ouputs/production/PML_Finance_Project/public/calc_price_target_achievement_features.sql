create function calc_price_target_achievement_features(p_isin text DEFAULT NULL::text)
    returns TABLE
            (
                isin                       text,
...
alter function calc_price_target_achievement_features(text) owner to postgres;
