create function information_schema.calc_total_debt_temporal(p_isin text DEFAULT NULL::text)
    returns TABLE
            (
                isin                 text,
                debt_fq              numeric,
...
alter function information_schema.calc_total_debt_temporal(unknown) owner to postgres;
