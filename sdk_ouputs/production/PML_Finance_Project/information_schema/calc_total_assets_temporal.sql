create function information_schema.calc_total_assets_temporal(p_isin text DEFAULT NULL::text)
    returns TABLE
            (
                isin               text,
                assets_fq          numeric,
...
alter function information_schema.calc_total_assets_temporal(unknown) owner to postgres;
