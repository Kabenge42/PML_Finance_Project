create function information_schema.calc_dividend_yield_comprehensive(p_isin text DEFAULT NULL::text)
    returns TABLE
            (
                isin                      text,
...
alter function information_schema.calc_dividend_yield_comprehensive(unknown) owner to postgres;
