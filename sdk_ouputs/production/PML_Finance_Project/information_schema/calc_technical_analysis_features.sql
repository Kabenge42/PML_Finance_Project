create function information_schema.calc_technical_analysis_features(p_isin text DEFAULT NULL::text)
    returns TABLE
            (
                isin                      text,
...
alter function information_schema.calc_technical_analysis_features(unknown) owner to postgres;
