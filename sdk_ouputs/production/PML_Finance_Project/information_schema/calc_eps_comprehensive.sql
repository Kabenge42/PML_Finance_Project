create function information_schema.calc_eps_comprehensive(p_isin text DEFAULT NULL::text)
    returns TABLE
            (
                isin                 text,
...
alter function information_schema.calc_eps_comprehensive(unknown) owner to postgres;
