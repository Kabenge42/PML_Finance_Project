create function information_schema.calc_quality_momentum_composite(p_isin text DEFAULT NULL::text)
    returns TABLE
            (
                isin                   text,
...
alter function information_schema.calc_quality_momentum_composite(unknown) owner to postgres;
