create function information_schema.calc_net_income_comprehensive(p_isin text DEFAULT NULL::text)
    returns TABLE
            (
                isin                       text,
...
alter function information_schema.calc_net_income_comprehensive(unknown) owner to postgres;
