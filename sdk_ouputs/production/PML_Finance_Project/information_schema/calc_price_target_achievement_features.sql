create function information_schema.calc_price_target_achievement_features(p_isin text DEFAULT NULL::text)
    returns TABLE
            (
                isin                       text,
...
alter function information_schema.calc_price_target_achievement_features(unknown) owner to postgres;
