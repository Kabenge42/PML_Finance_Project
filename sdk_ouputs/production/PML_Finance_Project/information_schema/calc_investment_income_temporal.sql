create function information_schema.calc_investment_income_temporal(p_isin text DEFAULT NULL::text)
    returns TABLE
            (
                isin                         text,
...
alter function information_schema.calc_investment_income_temporal(unknown) owner to postgres;
