create view information_schema.vw_features_technical_analysis
...
FROM information_schema.vw_identifier_columns id
         LEFT JOIN information_schema.calc_technical_analysis_features() ta(isin, ema_slope_20d, ema_trend_consistency,
                                                                            ...
                                                                            volatility_term_structure) USING (isin);

comment on view information_schema.vw_features_technical_analysis is 'Technical analysis indicators including EMA trends, volume signals, and volatility patterns.
    Source function: calc_technical_analysis_features';

alter table information_schema.vw_features_technical_analysis
    owner to postgres;
