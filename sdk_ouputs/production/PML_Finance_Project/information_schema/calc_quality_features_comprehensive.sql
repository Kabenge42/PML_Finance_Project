create function information_schema.calc_quality_features_comprehensive(p_isin text DEFAULT NULL::text)
    returns TABLE
            (
                isin                          text,
...
alter function information_schema.calc_quality_features_comprehensive(unknown) owner to postgres;
