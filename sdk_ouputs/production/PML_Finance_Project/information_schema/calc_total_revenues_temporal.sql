create function information_schema.calc_total_revenues_temporal(p_isin text DEFAULT NULL::text)
    returns TABLE
            (
                isin                  text,
                revenue_fq            numeric,
...
alter function information_schema.calc_total_revenues_temporal(unknown) owner to postgres;
