create function information_schema.calc_ebit_ebitda_comprehensive(p_isin text DEFAULT NULL::text)
    returns TABLE
            (
                isin                  text,
                ebit_fq               numeric,
...
alter function information_schema.calc_ebit_ebitda_comprehensive(unknown) owner to postgres;
