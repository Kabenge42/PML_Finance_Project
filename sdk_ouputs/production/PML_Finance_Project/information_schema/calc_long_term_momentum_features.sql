create function information_schema.calc_long_term_momentum_features(p_isin text DEFAULT NULL::text)
    returns TABLE
            (
                isin                     text,
...
alter function information_schema.calc_long_term_momentum_features(unknown) owner to postgres;
