create view information_schema.vw_features_leverage_liquidity
...
FROM information_schema.vw_identifier_columns id
         ...
         LEFT JOIN information_schema.calc_efficiency_ratios() er(isin, asset_turnover, inventory_turnover,
                                                                  receivables_days, working_capital_turns) USING (isin)
         ...
         LEFT JOIN information_schema.calc_working_capital_deep_features() wcd(isin, working_capital_ltm,
                                                                               ...
                                                                               wc_improvement_flag) USING (isin);

comment on view information_schema.vw_features_leverage_liquidity is 'Leverage and liquidity metrics including debt ratios, working capital, and balance sheet dynamics.
...
alter table information_schema.vw_features_leverage_liquidity
    owner to postgres;
