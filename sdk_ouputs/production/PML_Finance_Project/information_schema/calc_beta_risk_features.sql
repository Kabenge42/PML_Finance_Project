create function information_schema.calc_beta_risk_features(p_isin text DEFAULT NULL::text)
    returns TABLE
            (
                isin                 text,
                beta_1y              numeric,
...
alter function information_schema.calc_beta_risk_features(unknown) owner to postgres;
