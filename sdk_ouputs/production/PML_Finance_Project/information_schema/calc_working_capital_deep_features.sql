create function information_schema.calc_working_capital_deep_features(p_isin text DEFAULT NULL::text)
    returns TABLE
            (
                isin                 text,
...
alter function information_schema.calc_working_capital_deep_features(unknown) owner to postgres;
