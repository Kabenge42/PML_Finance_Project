create function information_schema.calc_employment_dynamics(p_isin text DEFAULT NULL::text)
    returns TABLE
            (
                isin                      text,
...
alter function information_schema.calc_employment_dynamics(unknown) owner to postgres;
