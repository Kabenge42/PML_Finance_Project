create function information_schema.calc_valuation_features(p_isin text DEFAULT NULL::text)
    returns TABLE
            (
                isin            text,
                p_e_ratio       numeric,
...
alter function information_schema.calc_valuation_features(unknown) owner to postgres;
