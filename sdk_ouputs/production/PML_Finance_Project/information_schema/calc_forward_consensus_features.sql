create function information_schema.calc_forward_consensus_features(p_isin text DEFAULT NULL::text)
    returns TABLE
            (
                isin                         text,
                pe_ntm                       numeric,
...
alter function information_schema.calc_forward_consensus_features(unknown) owner to postgres;
