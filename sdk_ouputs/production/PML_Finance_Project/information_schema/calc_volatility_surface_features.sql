create function information_schema.calc_volatility_surface_features(p_isin text DEFAULT NULL::text)
    returns TABLE
            (
                isin                      text,
                vol_1m                    numeric,
...
alter function information_schema.calc_volatility_surface_features(unknown) owner to postgres;
