create function information_schema.calc_revenue_estimate_consensus(p_isin text DEFAULT NULL::text)
    returns TABLE
            (
                isin                       text,
...
alter function information_schema.calc_revenue_estimate_consensus(unknown) owner to postgres;
