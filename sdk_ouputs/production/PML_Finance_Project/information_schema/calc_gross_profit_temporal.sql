create function information_schema.calc_gross_profit_temporal(p_isin text DEFAULT NULL::text)
    returns TABLE
            (
                isin                 text,
                gp_fq                numeric,
...
alter function information_schema.calc_gross_profit_temporal(unknown) owner to postgres;
