create function information_schema.calc_goodwill_temporal_features(p_isin text DEFAULT NULL::text)
    returns TABLE
            (
                isin                       text,
                goodwill_fq                numeric,
...
alter function information_schema.calc_goodwill_temporal_features(unknown) owner to postgres;
