create function information_schema.calc_cashflow_comprehensive(p_isin text DEFAULT NULL::text)
    returns TABLE
            (
                isin                    text,
                cfo_fq                  numeric,
...
alter function information_schema.calc_cashflow_comprehensive(unknown) owner to postgres;
