create function information_schema.calc_balance_sheet_dynamics(p_isin text DEFAULT NULL::text)
    returns TABLE
            (
                isin                      text,
...
alter function information_schema.calc_balance_sheet_dynamics(unknown) owner to postgres;
