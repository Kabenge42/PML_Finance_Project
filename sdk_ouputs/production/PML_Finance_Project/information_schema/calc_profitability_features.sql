create function information_schema.calc_profitability_features(p_isin text DEFAULT NULL::text)
    returns TABLE
            (
                isin                 text,
                roe                  numeric,
...
alter function information_schema.calc_profitability_features(unknown) owner to postgres;
