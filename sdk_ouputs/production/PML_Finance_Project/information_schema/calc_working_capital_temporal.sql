create function information_schema.calc_working_capital_temporal(p_isin text DEFAULT NULL::text)
    returns TABLE
            (
                isin                 text,
                wc_fq                numeric,
...
alter function information_schema.calc_working_capital_temporal(unknown) owner to postgres;
