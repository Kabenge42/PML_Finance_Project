-- ===========================================================================
-- kalman_portfolio.15c_forecast_summary
-- ===========================================================================
...
DROP TABLE IF EXISTS kalman_portfolio."15c_forecast_summary";
CREATE TABLE kalman_portfolio."15c_forecast_summary"
(
    "isin" TEXT,
    "ticker" TEXT,
    "name" TEXT,
...
COMMENT ON COLUMN kalman_portfolio."15c_forecast_summary"."er_mean" IS
    'Mean forward return over the Monte-Carlo horizon. Raw decimal.';
COMMENT ON COLUMN kalman_portfolio."15c_forecast_summary"."er_sd" IS
    'Pooled sd of the forward-return draws. Denominator of expected_sharpe_ratio.';
COMMENT ON COLUMN kalman_portfolio."15c_forecast_summary"."er_p05" IS
    '5th percentile forward return. Drives the upper out_of_support test.';
COMMENT ON COLUMN kalman_portfolio."15c_forecast_summary"."er_p95" IS
    '95th percentile forward return. Drives the lower out_of_support test.';
COMMENT ON COLUMN kalman_portfolio."15c_forecast_summary"."prob_pos" IS
...
COMMENT ON COLUMN kalman_portfolio."15c_forecast_summary"."run_id" IS
    'Export provenance. Every table written by one run shares it.';
COMMENT ON COLUMN kalman_portfolio."15c_forecast_summary"."exported_at" IS
    'Export provenance timestamp (UTC).';
COMMENT ON COLUMN kalman_portfolio."15c_forecast_summary"."source_sha" IS
...
COMMENT ON COLUMN kalman_portfolio."15c_forecast_summary"."source_dirty" IS
...
CREATE UNIQUE INDEX IF NOT EXISTS idx_15c_forecast_summary_isin
    ON kalman_portfolio."15c_forecast_summary" (isin);
