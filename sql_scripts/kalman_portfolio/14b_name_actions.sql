-- ===========================================================================
-- kalman_portfolio.14b_name_actions
-- ===========================================================================
...
DROP TABLE IF EXISTS kalman_portfolio."14b_name_actions";
CREATE TABLE kalman_portfolio."14b_name_actions"
(
    "isin" TEXT,
    "ticker" TEXT,
    "name" TEXT,
    ...
    "gate_strong_hi" DOUBLE PRECISION,
    "gate_hi" DOUBLE PRECISION,
    "gate_lo" DOUBLE PRECISION,
    "gate_strong_lo" DOUBLE PRECISION,
    "consensus_gap" DOUBLE PRECISION,
    "run_id" TEXT,
    "exported_at" TEXT,
    "source_sha" TEXT,
...
COMMENT ON COLUMN kalman_portfolio."14b_name_actions"."expected_upside_sd" IS
...
COMMENT ON COLUMN kalman_portfolio."14b_name_actions"."prob_pos" IS
...
COMMENT ON COLUMN kalman_portfolio."14b_name_actions"."implied_upside" IS
    'Analyst consensus upside, original_target/original_price - 1. Raw decimal.';
COMMENT ON COLUMN kalman_portfolio."14b_name_actions"."shrink_gain" IS
...
COMMENT ON COLUMN kalman_portfolio."14b_name_actions"."kalman_gain" IS
...
COMMENT ON COLUMN kalman_portfolio."14b_name_actions"."er_mean" IS
    'Mean forward return over the Monte-Carlo horizon. Raw decimal.';
COMMENT ON COLUMN kalman_portfolio."14b_name_actions"."er_sd" IS
    'Pooled sd of the forward-return draws. Denominator of expected_sharpe_ratio.';
COMMENT ON COLUMN kalman_portfolio."14b_name_actions"."er_p05" IS
    '5th percentile forward return. Drives the upper out_of_support test.';
COMMENT ON COLUMN kalman_portfolio."14b_name_actions"."er_p95" IS
    '95th percentile forward return. Drives the lower out_of_support test.';
COMMENT ON COLUMN kalman_portfolio."14b_name_actions"."mc_prob_pos" IS
    'Share of Monte-Carlo forward-return draws above zero.';
COMMENT ON COLUMN kalman_portfolio."14b_name_actions"."p_upside_pos_cond" IS
...
COMMENT ON COLUMN kalman_portfolio."14b_name_actions"."run_id" IS
    'Export provenance. Every table written by one run shares it.';
COMMENT ON COLUMN kalman_portfolio."14b_name_actions"."exported_at" IS
    'Export provenance timestamp (UTC).';
COMMENT ON COLUMN kalman_portfolio."14b_name_actions"."source_sha" IS
...
COMMENT ON COLUMN kalman_portfolio."14b_name_actions"."source_dirty" IS
...
CREATE UNIQUE INDEX IF NOT EXISTS idx_14b_name_actions_isin
    ON kalman_portfolio."14b_name_actions" (isin);
