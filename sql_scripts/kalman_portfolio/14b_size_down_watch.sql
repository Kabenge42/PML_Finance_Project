-- ===========================================================================
-- kalman_portfolio.14b_size_down_watch
-- ===========================================================================
...
DROP TABLE IF EXISTS kalman_portfolio."14b_size_down_watch";
CREATE TABLE kalman_portfolio."14b_size_down_watch"
(
    "isin" TEXT,
    "ticker" TEXT,
    "name" TEXT,
    ...
    "flag_wide_band" BOOLEAN,
    "flag_thin_coverage" BOOLEAN,
    "size_down_flag" BOOLEAN,
    "band_threshold" DOUBLE PRECISION,
    "run_id" TEXT,
    "exported_at" TEXT,
    "source_sha" TEXT,
...
COMMENT ON COLUMN kalman_portfolio."14b_size_down_watch"."expected_upside_sd" IS
...
COMMENT ON COLUMN kalman_portfolio."14b_size_down_watch"."prob_pos" IS
...
COMMENT ON COLUMN kalman_portfolio."14b_size_down_watch"."implied_upside" IS
    'Analyst consensus upside, original_target/original_price - 1. Raw decimal.';
COMMENT ON COLUMN kalman_portfolio."14b_size_down_watch"."shrink_gain" IS
...
COMMENT ON COLUMN kalman_portfolio."14b_size_down_watch"."kalman_gain" IS
...
COMMENT ON COLUMN kalman_portfolio."14b_size_down_watch"."er_mean" IS
    'Mean forward return over the Monte-Carlo horizon. Raw decimal.';
COMMENT ON COLUMN kalman_portfolio."14b_size_down_watch"."er_sd" IS
    'Pooled sd of the forward-return draws. Denominator of expected_sharpe_ratio.';
COMMENT ON COLUMN kalman_portfolio."14b_size_down_watch"."er_p05" IS
    '5th percentile forward return. Drives the upper out_of_support test.';
COMMENT ON COLUMN kalman_portfolio."14b_size_down_watch"."er_p95" IS
    '95th percentile forward return. Drives the lower out_of_support test.';
COMMENT ON COLUMN kalman_portfolio."14b_size_down_watch"."mc_prob_pos" IS
    'Share of Monte-Carlo forward-return draws above zero.';
COMMENT ON COLUMN kalman_portfolio."14b_size_down_watch"."p_upside_pos_cond" IS
...
COMMENT ON COLUMN kalman_portfolio."14b_size_down_watch"."run_id" IS
    'Export provenance. Every table written by one run shares it.';
COMMENT ON COLUMN kalman_portfolio."14b_size_down_watch"."exported_at" IS
    'Export provenance timestamp (UTC).';
COMMENT ON COLUMN kalman_portfolio."14b_size_down_watch"."source_sha" IS
...
COMMENT ON COLUMN kalman_portfolio."14b_size_down_watch"."source_dirty" IS
...
CREATE UNIQUE INDEX IF NOT EXISTS idx_14b_size_down_watch_isin
    ON kalman_portfolio."14b_size_down_watch" (isin);
