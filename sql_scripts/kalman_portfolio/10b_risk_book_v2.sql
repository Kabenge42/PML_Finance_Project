-- ===========================================================================
-- kalman_portfolio.10b_risk_book_v2
-- ===========================================================================
...
DROP TABLE IF EXISTS kalman_portfolio."10b_risk_book_v2";
CREATE TABLE kalman_portfolio."10b_risk_book_v2"
(
    "isin" TEXT,
    "ticker" TEXT,
    "name" TEXT,
...
COMMENT ON COLUMN kalman_portfolio."10b_risk_book_v2"."expected_upside_sd" IS
...
COMMENT ON COLUMN kalman_portfolio."10b_risk_book_v2"."prob_pos" IS
...
COMMENT ON COLUMN kalman_portfolio."10b_risk_book_v2"."implied_upside" IS
    'Analyst consensus upside, original_target/original_price - 1. Raw decimal.';
COMMENT ON COLUMN kalman_portfolio."10b_risk_book_v2"."shrink_gain" IS
...
COMMENT ON COLUMN kalman_portfolio."10b_risk_book_v2"."kalman_gain" IS
...
COMMENT ON COLUMN kalman_portfolio."10b_risk_book_v2"."er_mean" IS
    'Mean forward return over the Monte-Carlo horizon. Raw decimal.';
COMMENT ON COLUMN kalman_portfolio."10b_risk_book_v2"."er_sd" IS
    'Pooled sd of the forward-return draws. Denominator of expected_sharpe_ratio.';
COMMENT ON COLUMN kalman_portfolio."10b_risk_book_v2"."er_p05" IS
    '5th percentile forward return. Drives the upper out_of_support test.';
COMMENT ON COLUMN kalman_portfolio."10b_risk_book_v2"."er_p95" IS
    '95th percentile forward return. Drives the lower out_of_support test.';
COMMENT ON COLUMN kalman_portfolio."10b_risk_book_v2"."mc_prob_pos" IS
    'Share of Monte-Carlo forward-return draws above zero.';
COMMENT ON COLUMN kalman_portfolio."10b_risk_book_v2"."p_upside_pos_cond" IS
...
COMMENT ON COLUMN kalman_portfolio."10b_risk_book_v2"."expected_sharpe_ratio" IS
...
COMMENT ON COLUMN kalman_portfolio."10b_risk_book_v2"."run_id" IS
    'Export provenance. Every table written by one run shares it.';
COMMENT ON COLUMN kalman_portfolio."10b_risk_book_v2"."exported_at" IS
    'Export provenance timestamp (UTC).';
COMMENT ON COLUMN kalman_portfolio."10b_risk_book_v2"."source_sha" IS
...
COMMENT ON COLUMN kalman_portfolio."10b_risk_book_v2"."source_dirty" IS
...
CREATE UNIQUE INDEX IF NOT EXISTS idx_10b_risk_book_v2_isin
    ON kalman_portfolio."10b_risk_book_v2" (isin);
