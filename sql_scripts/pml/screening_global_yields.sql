CREATE TABLE screening_global_yields
(
	ticker     text,
	name       text,
	...
	country    text
		CONSTRAINT screening_global_yields_country_mapping_country_fk REFERENCES country_mapping (country) NOT ENFORCED,
	term       text
);

ALTER TABLE screening_global_yields
	OWNER TO postgres;