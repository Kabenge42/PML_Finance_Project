...
(
	column_name text NOT NULL
		CONSTRAINT fk_column_name REFERENCES pml.pml_df_metadata ON DELETE CASCADE,
...
CREATE INDEX idx_pml_df_feature_alias_model ON pml.pml_df_feature_alias (model_target);