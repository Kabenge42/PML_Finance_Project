create function pml.piotroski_f_score(roa numeric, roa_prev numeric, cfo numeric, ni numeric, ltde numeric, ltde_prev numeric, cr numeric, cr_prev numeric, shrs numeric, shrs_prev numeric, gpm numeric, gpm_prev numeric, at numeric, at_prev numeric) returns integer
	immutable
	parallel safe
	language sql
as
