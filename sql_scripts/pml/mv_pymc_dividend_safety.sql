create materialized view pml.mv_pymc_dividend_safety
as
SELECT isin,
       ticker,
       trading_region,
       ...
       pml.safe_divide(dividend_per_share_ltm,
                       NULLIF(net_eps_basic_ltm, 0::double precision))                            AS feat_eps_payout_ratio,
...
create unique index idx_mv_pymc_dividend_safety_isin
	on pml.mv_pymc_dividend_safety (isin)
;