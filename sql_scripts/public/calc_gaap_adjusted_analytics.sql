CREATE FUNCTION public.calc_gaap_adjusted_analytics(p_isin text DEFAULT NULL::text)
...
ALTER FUNCTION public.calc_gaap_adjusted_analytics(unknown) OWNER TO postgres;