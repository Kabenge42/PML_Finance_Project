create function calc_dividend_yield_comprehensive(p_isin text DEFAULT NULL::text)
...
alter function calc_dividend_yield_comprehensive(text) owner to postgres;
