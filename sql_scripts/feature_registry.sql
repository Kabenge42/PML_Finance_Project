...
VALUES
    ...
    ('feat_ev_sales_ratio', 'ev_sales_ratio', 'Valuation Ratios', 'calc_valuation_features',
     ...
     CURRENT_TIMESTAMP),
    ('feat_dividend_yield', 'dividend_yield', 'Valuation Ratios', 'calc_valuation_features', 'Dividend yield (LTM)',
    ...
    ('feat_non_operating_income_share', 'non_operating_income_share', 'Accounting Quality',
     ...
     ARRAY ['Interest Income On Investments (LTM)', 'Net Income - (IS) (LTM)'], 'Interest Income On Investments (LTM)',
     'ratio', 'NUMERIC', CURRENT_TIMESTAMP),
