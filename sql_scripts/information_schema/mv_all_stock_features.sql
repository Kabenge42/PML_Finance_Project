create materialized view information_schema.mv_all_stock_features as
SELECT id.isin,
       id.ticker,
       id.name,
       id.description,
...
FROM information_schema.vw_identifier_columns id
         ...
         LEFT JOIN information_schema.calc_extended_valuation_timeseries() evt(isin, ev_sales_qoq_1q, ev_sales_qoq_2q,
                                                                               ...
                                                                               forward_pe_premium) ON id.isin = evt.isin
         LEFT JOIN information_schema.calc_tangible_book_features() tb(isin, tangible_book_value_fy,
                                                                       ...
                                                                       tbv_vs_calculated) ON id.isin = tb.isin
         LEFT JOIN information_schema.calc_momentum_features() mf(isin, price_momentum_1m, price_momentum_3m,
                                                                  price_momentum_6m, price_momentum_1y,
                                                                  price_momentum_5d, ema_crossover_20_50,
                                                                  ema_crossover_50_250, price_vs_ema_20d,
                                                                  price_vs_ema_250d, pct_off_52w_high,
                                                                  pct_above_52w_low, range_52w_position, beta_momentum,
                                                                  volatility_regime) ON id.isin = mf.isin
         LEFT JOIN information_schema.calc_long_term_momentum_features() ltm(isin, price_momentum_1y, price_momentum_3y,
                                                                             price_momentum_5y, long_term_trend_score,
                                                                             price_vs_ema_250d, multi_year_high_flag,
                                                                             secular_trend_flag, total_return_ytd,
                                                                             total_return_5y, total_return_10y,
                                                                             return_cagr_3y, return_cagr_10y,
         ...
         LEFT JOIN information_schema.calc_technical_analysis_features() ta(isin, ema_slope_20d, ema_trend_consistency,
                   ...
                   ON id.isin = ta.isin
         LEFT JOIN information_schema.calc_profitability_features() pf(isin, roe, roa, gross_margin_pct,
                                                                       operating_margin_pct, net_margin_pct,
                                                                       ebitda_margin_pct, roic, rnd_intensity,
                                                                       equity_multiplier) ON id.isin = pf.isin
         LEFT JOIN information_schema.calc_margin_trends() mt(isin, gross_margin_trend_yoy, operating_margin_trend,
                                                              net_margin_trend_yoy, ebitda_margin_trend,
                                                              margin_expansion_flag, margin_stability_score)
                   ON id.isin = mt.isin
         LEFT JOIN information_schema.calc_ebit_ebitda_comprehensive() eec(isin, ebit_fq, ebit_ltm, ebit_fy, ebit_1fy,
                                                                           ebitda_fq, ebitda_ltm, ebitda_fy, ebitda_1fy,
                                                                           ebit_2fy, ebit_3fy, ebit_4fy, ebitda_2fy,
                                                                           ebitda_3fy, ebitda_4fy, ebit_1fqfq,
                                                                           ebit_2fqfq, ebit_3fqfq, ebit_4fqfq,
                                                                           ebitda_1fqfq, ebitda_2fqfq, ebitda_3fqfq,
                                                                           ebitda_4fqfq, ebit_5yavgfq, ebit_5yavgltm,
                                                                           ebitda_5yavgfq, ebitda_5yavgltm, ebit_adj_fq,
                                                                           ebit_adj_ltm, ebit_adj_fy, ebitda_adj_fq,
                                                                           ebitda_adj_ltm, ebitda_adj_fy,
                                                                           ebit_growth_yoy, ebitda_growth_yoy,
                                                                           ebit_margin_ltm, ebitda_margin_ltm,
                                                                           ebit_positive_years, ebitda_positive_years,
                                                                           ebit_qoq_growth, ebitda_qoq_growth,
                                                                           ebit_cagr_3y, ebitda_cagr_3y, ebit_vs_5y_avg,
                                                                           ebitda_vs_5y_avg) ON id.isin = eec.isin
         LEFT JOIN information_schema.calc_gross_profit_temporal() gpt(isin, gp_fq, gp_fy, gp_ltm, gp_1fqfq, gp_2fqfq,
                                                                       gp_3fqfq, gp_4fqfq, gp_1fy, gp_2fy, gp_3fy,
                                                                       gp_4fy, gp_qoq_growth, gp_yoy_growth,
                                                                       gp_margin_fq, gp_margin_trend,
                                                                       gp_positive_quarters, gp_margin_expansion)
                   ON id.isin = gpt.isin
         LEFT JOIN information_schema.calc_earnings_features() ef(isin, eps_surprise_pct, revenue_surprise_pct,
                                                                  eps_adjustment_ratio, gaap_adj_eps_gap_pct,
                                                                  ebitda_adjustment_ratio, eps_quarterly_trend,
                                                                  eps_yoy_growth) ON id.isin = ef.isin
         LEFT JOIN information_schema.calc_eps_trajectory_features() etf(isin, eps_qoq_growth, eps_yoy_quarterly,
                                                                         eps_positive_streak, eps_cagr_3y, eps_cagr_5y,
                                                                         eps_growth_accel, eps_vs_5y_avg,
                                                                         eps_improvement_count, eps_trajectory_score,
                                                                         eps_stability) ON id.isin = etf.isin
         LEFT JOIN information_schema.calc_eps_comprehensive() ec(isin, eps_basic_fq, eps_basic_ltm, eps_basic_fy,
                                                                  eps_adj_ltm, eps_norm_est_fy1e, eps_growth_yoy,
                                                                  eps_cagr_3y, eps_adjustment_ratio, eps_positive_years,
                                                                  eps_trajectory_score) ON id.isin = ec.isin
         LEFT JOIN information_schema.calc_eps_continuing_features() ecf(isin, eps_cont_ltm, eps_cont_fq, eps_cont_fy,
                                                                         eps_cont_1fqfq, eps_cont_2fqfq, eps_cont_3fqfq,
                                                                         eps_cont_4fqfq, eps_cont_1fy, eps_cont_2fy,
                                                                         eps_cont_3fy, eps_cont_4fy,
                                                                         eps_cont_qoq_growth, eps_cont_yoy_growth,
                                                                         eps_cont_cagr_3y, eps_cont_vs_total_eps,
                                                                         eps_cont_positive_streak,
                                                                         eps_cont_trajectory_score,
                                                                         discontinued_ops_impact,
                                                                         core_earnings_stability) ON id.isin = ecf.isin
         LEFT JOIN information_schema.calc_gaap_adjusted_analytics() gaa(isin, eps_adjustment_spread_ltm,
                   ...
                   ON id.isin = gaa.isin
         LEFT JOIN information_schema.calc_gaap_revision_features() grf(isin, gaap_revision_momentum, gaap_revision_1m,
                                                                        gaap_revision_3m, gaap_revision_6m,
                                                                        gaap_revision_1y, gaap_vs_norm_revision_spread,
         ...
         LEFT JOIN information_schema.calc_quality_features() qf(isin, has_goodwill_impairment, has_asset_writedown,
                                                                 ...
                                                                 quick_ratio) ON id.isin = qf.isin
         ...
         LEFT JOIN information_schema.calc_quality_features_comprehensive() qfc(isin, goodwill_impairment_ltm,
                   ...
                   ON id.isin = qfc.isin
         LEFT JOIN information_schema.calc_leverage_features() lf(isin, debt_to_equity, debt_to_assets, equity_ratio,
                                                                  interest_coverage, current_ratio, cash_ratio,
                                                                  working_capital_ratio) ON id.isin = lf.isin
         LEFT JOIN information_schema.calc_efficiency_ratios() er(isin, asset_turnover, inventory_turnover,
                                                                  receivables_days, working_capital_turns)
                   ON id.isin = er.isin
         LEFT JOIN information_schema.calc_balance_sheet_dynamics() bsd(isin, cash_to_assets_pct, cash_change_qoq,
                                                                        cash_vs_5y_avg, inventory_change_yoy,
                                                                        inventory_vs_5y_avg, receivables_change_yoy,
                   ...
                   ON id.isin = bsd.isin
         LEFT JOIN information_schema.calc_working_capital_temporal() wct(isin, wc_fq, wc_fy, wc_ltm, wc_5yavgfy,
                                                                          wc_1fq, wc_2fq, wc_3fq, wc_4fq, wc_1fy,
                                                                          wc_2fy, wc_3fy, wc_4fy, wc_qoq_change,
                                                                          wc_yoy_change, wc_4q_trend, wc_vs_5y_avg,
                                                                          wc_positive_quarters, wc_improving_flag,
                                                                          wc_volatility) ON id.isin = wct.isin
         LEFT JOIN information_schema.calc_total_debt_temporal() tdt(isin, debt_fq, debt_fy, debt_ltm, debt_1fq,
                                                                     debt_2fq, debt_3fq, debt_4fq, debt_1fy, debt_2fy,
                                                                     debt_3fy, debt_4fy, debt_qoq_change,
                                                                     debt_yoy_change, debt_4q_trend, debt_3y_cagr,
                                                                     debt_deleveraging, debt_to_equity_trend)
                   ON id.isin = tdt.isin
         LEFT JOIN information_schema.calc_working_capital_deep_features() wcd(isin, working_capital_ltm,
                                                                               working_capital_fq, working_capital_fy,
                                                                               wc_to_revenue, wc_to_assets,
                                                                               wc_change_qoq, wc_change_yoy,
                                                                               days_working_capital,
                                                                               wc_efficiency_score, negative_wc_flag,
                                                                               wc_improvement_flag)
                   ON id.isin = wcd.isin
         LEFT JOIN information_schema.calc_sentiment_features() sf(isin, analyst_bullish_pct, analyst_bearish_pct,
                                                                   analyst_neutral_pct, analyst_conviction,
                                                                   upside_potential, price_target_spread_pct,
         ...
         LEFT JOIN information_schema.calc_price_target_dynamics() ptd(isin, pt_momentum_1w, pt_momentum_1m,
                                                                       pt_momentum_3m, pt_momentum_6m, pt_momentum_1y,
                                                                       pt_median_momentum_1m, pt_median_momentum_3m,
                                                                       pt_acceleration_short, pt_acceleration_long,
         ...
         LEFT JOIN information_schema.calc_dividend_yield_comprehensive() dyc(isin, div_yield_ltm, div_yield_ntm,
                   ...
                   ON id.isin = dyc.isin
         LEFT JOIN information_schema.calc_employment_features() emf(isin, revenue_per_employee, profit_per_employee,
         ...
         LEFT JOIN information_schema.calc_cashflow_features() cf(isin, cfo_to_net_income, fcf_to_net_income,
                   ...
                   ON id.isin = cf.isin
         LEFT JOIN information_schema.calc_enhanced_cashflow_features() ecff(isin, fcf_positive_years,
         ...
         LEFT JOIN information_schema.calc_temporal_features() tf(isin, fiscal_quarter, fiscal_month, fiscal_year,
                                                                  days_to_earnings, earnings_report_recency,
                                                                  reporting_lag, fiscal_year_progress)
                   ON id.isin = tf.isin
         LEFT JOIN information_schema.calc_fiscal_calendar_features() fcf(isin, days_since_last_report, days_to_fy_end,
                                                                          ...
                                                                          fiscal_quarter_progress) ON id.isin = fcf.isin
         LEFT JOIN information_schema.calc_total_assets_temporal() tat(isin, assets_fq, assets_fy, assets_ltm,
                                                                       assets_1fq, assets_2fq, assets_3fq, assets_4fq,
                                                                       assets_1fy, assets_2fy, assets_3fy, assets_4fy,
                                                                       assets_qoq_growth, assets_yoy_growth,
                                                                       assets_3y_cagr, asset_growth_accel,
                                                                       asset_base_stable) ON id.isin = tat.isin
         LEFT JOIN information_schema.calc_inventory_temporal_features() itf(isin, inventory_ltm, inventory_fq,
                                                                             inventory_fy, inventory_1fq, inventory_2fq,
                                                                             inventory_3fq, inventory_4fq,
                                                                             inventory_1fy, inventory_2fy,
                                                                             inventory_3fy, inventory_4fy,
                                                                             inventory_qoq_change, inventory_yoy_change,
                                                                             inventory_4q_trend, inventory_vs_5y_avg,
                                                                             inventory_days, inventory_turnover,
         ...
         LEFT JOIN information_schema.calc_goodwill_temporal_features() gtf(isin, goodwill_fq, goodwill_ltm,
                                                                            goodwill_fy, goodwill_1fq, goodwill_2fq,
                                                                            goodwill_3fq, goodwill_4fq, goodwill_1fy,
                                                                            goodwill_2fy, goodwill_3fy, goodwill_4fy,
                                                                            goodwill_qoq_change, goodwill_yoy_change,
                                                                            goodwill_3y_growth, goodwill_vs_5y_avg,
         ...
         LEFT JOIN information_schema.calc_interest_income_features() iif(isin, interest_income_ltm,
                   ...
                   ON id.isin = iif.isin
         LEFT JOIN information_schema.calc_composite_scores() cs(isin, piotroski_f_score, dilution_score, quality_momentum_score)
                   ON id.isin = cs.isin
         LEFT JOIN information_schema.calc_net_income_comprehensive() nic(isin, net_income_is_fq, net_income_is_ltm,
                                                                          net_income_is_fy, net_income_adj_ltm,
                                                                          normalized_ni_ltm, net_income_is_1fqfq,
                                                                          net_income_is_2fqfq, net_income_is_3fqfq,
                                                                          net_income_is_4fqfq, net_income_is_1fy,
                                                                          net_income_is_2fy, net_income_is_3fy,
                                                                          net_income_is_4fy, net_income_is_5yavgfq,
                                                                          net_income_is_5yavgltm, normalized_ni_5yavgfq,
                                                                          normalized_ni_5yavgltm, net_income_growth_yoy,
                                                                          net_income_margin_ltm, ni_adjustment_ratio,
         ...
         LEFT JOIN information_schema.calc_volatility_surface_features() vsf(isin, vol_1m, vol_3m, vol_6m, vol_1y,
                                                                             vol_term_spread_short,
                                                                             vol_term_spread_long, vol_ratio_3m_1y,
                                                                             vol_hump, beta_1y, beta_2y, beta_5y,
                                                                             beta_term_structure, beta_convexity,
                                                                             realized_vs_implied_proxy)
                   ON id.isin = vsf.isin
         LEFT JOIN information_schema.calc_tax_rate_features() txf(isin, effective_tax_rate_ltm, effective_tax_rate_fy,
                                                                   tax_rate_yoy_change, tax_rate_qoq_change,
                                                                   tax_rate_stability, low_tax_flag, tax_rate_trend_4q)
                   ON id.isin = txf.isin
         LEFT JOIN information_schema.calc_opex_temporal_features() otf(isin, opex_fq, opex_ltm, opex_fy,
                                                                        opex_qoq_growth, opex_yoy_growth,
                                                                        opex_vs_revenue_trend, sga_qoq_growth,
                                                                        sga_yoy_growth, operating_leverage_score)
                   ON id.isin = otf.isin
         LEFT JOIN information_schema.calc_asset_sale_features() asf(isin, gain_loss_on_sale_of_assets_ltm,
                                                                     asset_sale_frequency, asset_sale_trend)
                   ON id.isin = asf.isin
         LEFT JOIN information_schema.calc_fcf_estimate_features() fcfe(isin, fcf_est_avg_fy1e, fcf_est_avg_fy2e,
                                                                        fcf_est_avg_fy3e, fcf_est_avg_fy4e,
                                                                        fcf_est_avg_fy5e, fcf_est_cagr_5y,
                                                                        fcf_est_trend) ON id.isin = fcfe.isin
         LEFT JOIN information_schema.calc_dividend_history_features() dhf(isin, div_yield_2fy, div_yield_3fy,
                                                                           div_yield_4fy, div_yield_5fy,
                                                                           div_yield_trend_3y, div_yield_volatility,
                                                                           div_yield_declining_flag, div_yield_mean_5y,
                                                                           div_yield_vs_5y_mean) ON id.isin = dhf.isin
         LEFT JOIN information_schema.calc_investment_income_temporal() iit(isin, inv_income_ltm, inv_income_fq,
                                                                            inv_income_fy, inv_income_qoq_growth,
                                                                            inv_income_yoy_growth,
                                                                            inv_income_to_revenue, inv_income_trend_3y,
                                                                            inv_income_positive_quarters,
                                                                            financial_company_proxy)
                   ON id.isin = iit.isin
         LEFT JOIN information_schema.calc_share_dilution_tracking() sdt(isin, shrs_out_1fy, shares_yoy_change_pct, net_buyback_flag)
                   ON id.isin = sdt.isin
         LEFT JOIN information_schema.calc_forward_consensus_features() fcnf(isin, pe_ntm, pe_est_fy1,
                                                                             pe_forward_discount, eps_gaap_vs_norm_ntm,
                                                                             eps_gaap_vs_norm_fy1e,
                                                                             forward_adjustment_trend, ebitda_est_ntm,
                                                                             ebitda_est_fy1e, ev_ebitda_est_fy1,
                                                                             ebitda_forward_growth,
                                                                             earnings_revision_divergence,
                                                                             forward_pe_vs_sector_proxy)
                   ON id.isin = fcnf.isin;

comment on materialized view information_schema.mv_all_stock_features is 'Unified materialized view containing all calculated stock features.
...
alter materialized view information_schema.mv_all_stock_features owner to postgres;

create unique index idx_mv_all_stock_features_isin
    on information_schema.mv_all_stock_features (isin);

create index idx_mv_all_stock_features_ticker
    on information_schema.mv_all_stock_features (ticker);

create index idx_mv_all_stock_features_sector_industry
    on information_schema.mv_all_stock_features (sector, industry);

create index idx_mv_all_stock_features_region_country
    on information_schema.mv_all_stock_features (region, country, trading_country);

create index idx_mv_all_stock_features_exchange
    on information_schema.mv_all_stock_features (exchange);
