create view information_schema.vw_features_balance_sheet
...
comment on view information_schema.vw_features_balance_sheet is 'Balance sheet temporal analysis including assets, inventory, and goodwill trends.
    Source functions: calc_total_assets_temporal, calc_inventory_temporal_features, calc_goodwill_temporal_features';

alter table information_schema.vw_features_balance_sheet
    owner to postgres;
