create function information_schema.calc_accounting_quality_features(p_isin text DEFAULT NULL::text)
    returns TABLE
            (
                isin                        text,
...
alter function information_schema.calc_accounting_quality_features(unknown) owner to postgres;
