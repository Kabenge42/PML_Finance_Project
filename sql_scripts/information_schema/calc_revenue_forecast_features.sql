create function information_schema.calc_revenue_forecast_features(p_isin text DEFAULT NULL::text)
    returns TABLE
            (
                isin                       text,
...
alter function information_schema.calc_revenue_forecast_features(unknown) owner to postgres;
