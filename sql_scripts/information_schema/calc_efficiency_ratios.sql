create function information_schema.calc_efficiency_ratios(p_isin text DEFAULT NULL::text)
    returns TABLE
            (
                isin                  text,
...
alter function information_schema.calc_efficiency_ratios(unknown) owner to postgres;
