create function information_schema.calc_rnd_temporal_features(p_isin text DEFAULT NULL::text)
    returns TABLE
            (
                isin                    text,
                rnd_ltm                 numeric,
...
alter function information_schema.calc_rnd_temporal_features(unknown) owner to postgres;
