...
SELECT current_database()::sql_identifier              AS specific_catalog,
       ...
       NULL::name::sql_identifier                      AS module_catalog,
       NULL::name::sql_identifier                      AS module_schema,
       NULL::name::sql_identifier                      AS module_name,
       NULL::name::sql_identifier                      AS udt_catalog,
       NULL::name::sql_identifier                      AS udt_schema,
       NULL::name::sql_identifier                      AS udt_name,
       CASE
       ...
       NULL::name::sql_identifier                      AS character_set_catalog,
       NULL::name::sql_identifier                      AS character_set_schema,
       NULL::name::sql_identifier                      AS character_set_name,
       NULL::name::sql_identifier                      AS collation_catalog,
       NULL::name::sql_identifier                      AS collation_schema,
       NULL::name::sql_identifier                      AS collation_name,
       ...
       NULL::name::sql_identifier                      AS scope_catalog,
       NULL::name::sql_identifier                      AS scope_schema,
       NULL::name::sql_identifier                      AS scope_name,
       ...
       NULL::name::sql_identifier                      AS to_sql_specific_catalog,
       NULL::name::sql_identifier                      AS to_sql_specific_schema,
       NULL::name::sql_identifier                      AS to_sql_specific_name,
       ...
       NULL::name::sql_identifier                      AS result_cast_char_set_catalog,
       NULL::name::sql_identifier                      AS result_cast_char_set_schema,
       NULL::name::sql_identifier                      AS result_cast_char_set_name,
       NULL::name::sql_identifier                      AS result_cast_collation_catalog,
       NULL::name::sql_identifier                      AS result_cast_collation_schema,
       NULL::name::sql_identifier                      AS result_cast_collation_name,
       ...
       NULL::name::sql_identifier                      AS result_cast_type_udt_catalog,
       NULL::name::sql_identifier                      AS result_cast_type_udt_schema,
       NULL::name::sql_identifier                      AS result_cast_type_udt_name,
       NULL::name::sql_identifier                      AS result_cast_scope_catalog,
       NULL::name::sql_identifier                      AS result_cast_scope_schema,
       NULL::name::sql_identifier                      AS result_cast_scope_name,
       NULL::integer::cardinal_number                  AS result_cast_maximum_cardinality,
       NULL::name::sql_identifier                      AS result_cast_dtd_identifier
FROM pg_namespace n
