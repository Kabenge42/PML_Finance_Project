create function information_schema.calc_revenue_quarterly_features(p_isin text DEFAULT NULL::text)
    returns TABLE
            (
                isin                        text,
                revenue_fq                  numeric,
...
alter function information_schema.calc_revenue_quarterly_features(unknown) owner to postgres;
