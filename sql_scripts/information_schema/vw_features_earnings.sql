create view information_schema.vw_features_earnings
...
FROM information_schema.vw_identifier_columns id
         ...
         LEFT JOIN information_schema.calc_eps_comprehensive() ec(isin, eps_basic_fq, eps_basic_ltm, eps_basic_fy,
                                                                  ...
                                                                  eps_trajectory_score) USING (isin)
         LEFT JOIN information_schema.calc_eps_continuing_features() ecf(isin, eps_cont_ltm, eps_cont_fq, eps_cont_fy,
                                                                         ...
                                                                         core_earnings_stability) USING (isin)
...
comment on view information_schema.vw_features_earnings is 'Earnings metrics including EPS analysis, GAAP adjustments, and revision trends.
...
alter table information_schema.vw_features_earnings
    owner to postgres;
