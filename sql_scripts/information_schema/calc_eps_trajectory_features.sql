create function information_schema.calc_eps_trajectory_features(p_isin text DEFAULT NULL::text)
    returns TABLE
            (
                isin                  text,
...
alter function information_schema.calc_eps_trajectory_features(unknown) owner to postgres;
