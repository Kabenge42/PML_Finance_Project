create view information_schema.vw_features_analyst_sentiment
...
FROM information_schema.vw_identifier_columns id
         ...
         LEFT JOIN information_schema.calc_price_target_dynamics() ptd(isin, pt_momentum_1w, pt_momentum_1m,
                                                                       ...
                                                                       analyst_coverage_trend) USING (isin);

comment on view information_schema.vw_features_analyst_sentiment is 'Analyst sentiment metrics including ratings distribution and price target dynamics.
    Source functions: calc_sentiment_features, calc_price_target_dynamics';

alter table information_schema.vw_features_analyst_sentiment
    owner to postgres;
