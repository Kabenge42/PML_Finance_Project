create function information_schema.calc_piotroski_f_score(p_isin text DEFAULT NULL::text)
    returns TABLE
            (
                isin              text,
...
alter function information_schema.calc_piotroski_f_score(unknown) owner to postgres;
