create view information_schema.vw_features_composite_scores
...
comment on view information_schema.vw_features_composite_scores is 'Composite scoring metrics including Piotroski F-Score and earnings quality.
    Source functions: calc_composite_scores, calc_net_income_comprehensive';

alter table information_schema.vw_features_composite_scores
    owner to postgres;
