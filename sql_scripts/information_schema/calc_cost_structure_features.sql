create function information_schema.calc_cost_structure_features(p_isin text DEFAULT NULL::text)
    returns TABLE
            (
                isin                     text,
...
alter function information_schema.calc_cost_structure_features(unknown) owner to postgres;
