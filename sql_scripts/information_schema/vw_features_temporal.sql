create view information_schema.vw_features_temporal
...
FROM information_schema.vw_identifier_columns id
         LEFT JOIN information_schema.calc_temporal_features() tf(isin, fiscal_quarter, fiscal_month, fiscal_year,
                                                                  ...
                                                                  reporting_lag, fiscal_year_progress) USING (isin)
         LEFT JOIN information_schema.calc_fiscal_calendar_features() fcf(isin, days_since_last_report, days_to_fy_end,
                                                                          ...
                                                                          fiscal_quarter_progress) USING (isin);

comment on view information_schema.vw_features_temporal is 'Temporal and fiscal calendar features for earnings timing and seasonality.
    Source functions: calc_temporal_features, calc_fiscal_calendar_features';

alter table information_schema.vw_features_temporal
    owner to postgres;
