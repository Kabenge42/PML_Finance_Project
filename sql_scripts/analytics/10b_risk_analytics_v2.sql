-- ===========================================================================
-- analytics.10b_risk_analytics_v2
-- ===========================================================================
...
DROP TABLE IF EXISTS analytics."10b_risk_analytics_v2";
CREATE TABLE analytics."10b_risk_analytics_v2"
(
    "isin" TEXT,
    "ticker" TEXT,
    "name" TEXT,
...
COMMENT ON COLUMN analytics."10b_risk_analytics_v2"."er_p05" IS
    '5th percentile forward return. Drives the upper out_of_support test.';
COMMENT ON COLUMN analytics."10b_risk_analytics_v2"."er_p95" IS
    '95th percentile forward return. Drives the lower out_of_support test.';
COMMENT ON COLUMN analytics."10b_risk_analytics_v2"."mc_prob_pos" IS
    'Share of Monte-Carlo forward-return draws above zero.';
COMMENT ON COLUMN analytics."10b_risk_analytics_v2"."p_upside_pos_cond" IS
...
COMMENT ON COLUMN analytics."10b_risk_analytics_v2"."expected_sharpe_ratio" IS
...
COMMENT ON COLUMN analytics."10b_risk_analytics_v2"."out_of_support" IS
...
COMMENT ON COLUMN analytics."10b_risk_analytics_v2"."run_id" IS
    'Export provenance. Every table written by one run shares it.';
COMMENT ON COLUMN analytics."10b_risk_analytics_v2"."exported_at" IS
    'Export provenance timestamp (UTC).';
COMMENT ON COLUMN analytics."10b_risk_analytics_v2"."source_sha" IS
...
COMMENT ON COLUMN analytics."10b_risk_analytics_v2"."source_dirty" IS
...
CREATE UNIQUE INDEX IF NOT EXISTS idx_10b_risk_analytics_v2_isin
    ON analytics."10b_risk_analytics_v2" (isin);
