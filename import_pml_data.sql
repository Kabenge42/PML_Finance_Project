...
INSERT INTO pml_df (ticker, isin, name, description, region, country, trading_country, exchange, unit, sector, industry,
                    style_class, size_class, last_updated, income_statement_report_date, fy_end, next_earnings,
                    next_earnings_when, next_earnings_status, fy_end_date, next_income_statement_report_date,
                    next_fy_end_date, days_to_earnings, earnings_report_recency, expected_report_date,
                    dividend_record_currency, dividend_record_amount, dividend_record_frequency, dividend_streak,
                    dividend_record_announce_date, dividend_record_payable_date, dividend_record_record_date,
                    dividend_record_ex_date, market_cap, enterprise_value, last_price, price_target_ytd_ago,
                    total_return_ytd, price_target, price_target_low, price_target_median, price_target_high,
                    price_target_num, p_e_ntm, p_e_ltm, altman_z_score_fy, altman_z_score_fq, altman_z_score_ltm,
                    beta_1y, beta_2y, beta_5y, analyst_rating, num_strong_sell_ratings, num_strong_buys_ratings,
                    num_hold_ratings, num_buys_ratings, num_sell_ratings, num_no_opinion_ratings, market_cap_country_r,
                    tot_return_pct_cagr_3y, tot_return_pct_cagr_10y, total_return_5y, total_return_10y, volume_shrs,
                    dividend_per_share_ltm, div_yield_ind, div_yield_ltm, gross_profit_margin_pct_fy,
                    gross_profit_margin_pct_ltm, eps_norm_est_avg_ntm, eps_adj_neg1fy, eps_adj_fy, eps_adj_ltm,
                    eps_norm_est_avg_fy1e, buyback_yield_ltm, return_on_assets_roa_pct_ltm, return_on_assets_roa_pct_fy,
                    div_yield_neg1fyind, p_b_ltm, p_b_neg1fy, p_b_5yavg, div_yield_ttm, div_yield_ntm,
                    div_yield_5yavgltm, price_chg_pct_3m, one_day_pct, price_5d_ago, price_1w_ago, price_1m_ago,
                    price_3m_ago, price_6m_ago, price_1y_ago, price_3y_ago, price_5y_ago, price_qtd_ago, rel_volume,
                    shrs_out, shrs_out_neg1fy, common_dividends_paid_ltm, common_dividends_paid_fy, ev_sales_ltm,
                    ev_sales_ntm, ev_sales_neg1fyltm, ev_sales_neg2fyltm, ev_sales_neg3fyltm, ev_sales_3yavgltm,
                    ev_sales_neg1fqltm, ev_sales_neg2fqltm, ev_sales_neg3fqltm, ev_sales_neg4fqltm, w_52high_adj,
                    w_52low_adj, ema_20d, ema_50d, ema_100d, ema_250d, ev_ebitda_ltm, ev_ebitda_ntm,
                    ev_ebitda_neg1fyltm, ev_ebitda_neg1fqltm, ev_ebitda_3yavgltm, ev_ebitda_est_fy1, p_e_est_fy1,
                    p_e_neg1fyltm, p_e_neg2fyltm, p_e_neg3fyltm, p_e_3yavgltm, p_e_neg1fqltm, p_e_neg2fqltm,
                    p_e_neg3fqltm, p_e_5yavgltm, p_e_neg0fqqoqltm, p_e_neg0fyyoyltm, p_e_neg1fyyoyltm, p_e_neg0fqyoyltm,
                    full_time_employees_fq, full_time_employees_fy, full_time_employees_neg1fy,
...
SELECT NULLIF(TRIM(s."Ticker"), '')                                                                 AS ticker,
       ...
       text_to_numeric_safe(s."Shrs Out")                                                           AS shrs_out,
       text_to_numeric_safe(s."Shrs Out (-1FY)")                                                    AS shrs_out_neg1fy,
       ...
       text_to_numeric_safe(s."Shrs Out (-1FQ)")                            AS shrs_out_neg1fq,
       text_to_numeric_safe(s."Shrs Out (-2FQ)")                            AS shrs_out_neg2fq,
       text_to_numeric_safe(s."Shrs Out (-3FQ)")                            AS shrs_out_neg3fq,
       text_to_numeric_safe(s."Shrs Out (-4FQ)")                            AS shrs_out_neg4fq,
       text_to_numeric_safe(s."Shrs Out (-2FY)")                            AS shrs_out_neg2fy,
       text_to_numeric_safe(s."Shrs Out (-3FY)")                            AS shrs_out_neg3fy,
       text_to_numeric_safe(s."Shrs Out (-4FY)")                            AS shrs_out_neg4fy,
       text_to_numeric_safe(s."Shrs Out (-5FY)")                            AS shrs_out_neg5fy,
       text_to_numeric_safe(s."Shrs Out (3YAVG)")                           AS shrs_out_3yavg,
       text_to_numeric_safe(s."Shrs Out (5YAVG)")                           AS shrs_out_5yavg,
