...
INSERT INTO pml_df (ticker, isin, name, description, region, country, trading_country, exchange, unit, sector, industry,
                    ...
                    next_fy_end_date, expected_report_date, dividend_record_currency, dividend_record_amount,
                    dividend_record_frequency, dividend_streak, dividend_record_announce_date,
