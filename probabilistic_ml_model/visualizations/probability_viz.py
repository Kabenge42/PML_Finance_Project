...
def create_mcmc_anomaly_posterior_chart(
    ...
    Visualises the Student-t posterior and sector-level hierarchical
...
def create_mcmc_credit_risk_chart(
    ...
    Visualises the Metropolis-Hastings and Student-t posterior columns
...
def create_mcmc_dividend_cut_chart(
    ...
    Visualises the composite posterior from FCF coverage and payout ratio
...
def create_mcmc_price_target_chart(
    ...
    Visualises the Student-t posterior and parallel MCMC convergence
...
def create_mcmc_category_posterior_chart(
    ...
    Visualises the output of ``run_category_probability_analytics()``
