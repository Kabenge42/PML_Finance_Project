...
SELECT isin,
       ...
       -- ---- Observed analyst-target distribution (full) ----
       price_target,
       price_target_high,
       price_target_low,
       price_target_median,
       ...
       target_pct_high,
       target_pct_low,
       -- ---- Raw analyst rating counts (constant_data) ----
       num_strong_buys_ratings,
       num_buys_ratings,
       num_sell_ratings,
       num_strong_sell_ratings,
       -- ---- Raw 52-week range bounds (mutable_predictor) ----
       w_52high_adj,
       w_52low_adj,
       -- ---- Valuation mutable predictors ----
       p_e_ltm,
       p_e_3yavgltm,
       p_e_3yavgntm,
       p_e_5yavgltm,
       ...
       peg_3yavg,
       peg_5yavg,
       -- ---- Valuation lag snapshots (derived_input) ----
       p_e_neg1fqltm,
       p_e_neg2fqltm,
       p_e_neg3fqltm,
       p_e_neg4fqltm,
       ...
       peg_neg4fy,
       peg_neg5fy,
       -- ---- Price-target time-series snapshots (derived_input) ----
       price_target_1w_ago,
       price_target_1m_ago,
       price_target_6m_ago,
       price_target_1y_ago,
