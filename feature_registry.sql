...
VALUES
    ...
    -- MOMENTUM FEATURES
    ('feat_price_momentum_1m', 'price_momentum_1m', 'Momentum & Technical', 'calc_momentum_features',
     '1-month price momentum', ARRAY ['Last Price', 'Price (1M Ago)'], 'Last Price', 'growth', 'NUMERIC',
     CURRENT_TIMESTAMP),
    ('feat_price_momentum_3m', 'price_momentum_3m', 'Momentum & Technical', 'calc_momentum_features',
     '3-month price momentum', ARRAY ['Last Price', 'Price (3M Ago)'], 'Last Price', 'growth', 'NUMERIC',
     CURRENT_TIMESTAMP),
    ('feat_price_momentum_6m', 'price_momentum_6m', 'Momentum & Technical', 'calc_momentum_features',
     '6-month price momentum', ARRAY ['Last Price', 'Price (6M Ago)'], 'Last Price', 'growth', 'NUMERIC',
     CURRENT_TIMESTAMP),
    ('feat_price_momentum_1y', 'price_momentum_1y', 'Momentum & Technical', 'calc_momentum_features',
     '1-year price momentum', ARRAY ['Last Price', 'Price (1Y Ago)'], 'Last Price', 'growth', 'NUMERIC',
     CURRENT_TIMESTAMP),
    ('feat_price_momentum_5d', 'price_momentum_5d', 'Momentum & Technical', 'calc_momentum_features',
     '5-day price momentum', ARRAY ['Last Price', 'Price (5D Ago)'], 'Last Price', 'growth', 'NUMERIC',
     CURRENT_TIMESTAMP),
    ('feat_ema_crossover_20_50', 'ema_crossover_20_50', 'Momentum & Technical', 'calc_momentum_features',
     'EMA 20/50 crossover signal', ARRAY ['EMA (20D)', 'EMA (50D)'], 'EMA (20D)', 'flag', 'SMALLINT',
     CURRENT_TIMESTAMP),
    ('feat_ema_crossover_50_250', 'ema_crossover_50_250', 'Momentum & Technical', 'calc_momentum_features',
     'EMA 50/250 crossover signal', ARRAY ['EMA (50D)', 'EMA (250D)'], 'EMA (50D)', 'flag', 'SMALLINT',
     CURRENT_TIMESTAMP),
    ('feat_price_vs_ema_20d', 'price_vs_ema_20d', 'Momentum & Technical', 'calc_momentum_features',
     'Price vs 20-day EMA', ARRAY ['Last Price', 'EMA (20D)'], 'Last Price', 'ratio', 'NUMERIC', CURRENT_TIMESTAMP),
    ('feat_price_vs_ema_250d', 'price_vs_ema_250d', 'Momentum & Technical', 'calc_momentum_features',
     'Price vs 250-day EMA', ARRAY ['Last Price', 'EMA (250D)'], 'Last Price', 'ratio', 'NUMERIC', CURRENT_TIMESTAMP),
    ('feat_pct_off_52w_high', 'pct_off_52w_high', 'Momentum & Technical', 'calc_momentum_features',
     'Percentage off 52-week high', ARRAY ['52W High/Adj', 'Last Price'], '52W High/Adj', 'ratio', 'NUMERIC',
     CURRENT_TIMESTAMP),
    ('feat_pct_above_52w_low', 'pct_above_52w_low', 'Momentum & Technical', 'calc_momentum_features',
     'Percentage above 52-week low', ARRAY ['Last Price', '52W Low/Adj'], '52W Low/Adj', 'ratio', 'NUMERIC',
     CURRENT_TIMESTAMP),
    ('feat_range_52w_position', 'range_52w_position', 'Momentum & Technical', 'calc_momentum_features',
     'Position within 52-week range (0-1)', ARRAY ['Last Price', '52W Low/Adj', '52W High/Adj'], 'Last Price', 'score',
     'NUMERIC', CURRENT_TIMESTAMP),
    ('feat_beta_momentum', 'beta_momentum', 'Momentum & Technical', 'calc_momentum_features',
     'Beta momentum (1Y vs 5Y)', ARRAY ['Beta (1Y)', 'Beta (5Y)'], 'Beta (1Y)', 'difference', 'NUMERIC',
     CURRENT_TIMESTAMP),
    ('feat_volatility_regime', 'volatility_regime', 'Momentum & Technical', 'calc_momentum_features',
    ...
    ('feat_vol_1m', 'volatility_1m', 'Momentum & Technical', 'calc_volatility_surface_features', '1-month volatility',
     ARRAY ['Volatility (1M)'], 'Volatility (1M)', 'direct', 'NUMERIC', CURRENT_TIMESTAMP),
    ('feat_vol_3m', 'volatility_3m', 'Momentum & Technical', 'calc_volatility_surface_features', '3-month volatility',
     ARRAY ['Volatility (3M)'], 'Volatility (3M)', 'direct', 'NUMERIC', CURRENT_TIMESTAMP),
    ('feat_vol_6m', 'volatility_6m', 'Momentum & Technical', 'calc_volatility_surface_features', '6-month volatility',
     ARRAY ['Volatility (6M)'], 'Volatility (6M)', 'direct', 'NUMERIC', CURRENT_TIMESTAMP),
    ('feat_vol_1y', 'volatility_1y', 'Momentum & Technical', 'calc_volatility_surface_features', '1-year volatility',
     ARRAY ['Volatility (1Y)'], 'Volatility (1Y)', 'direct', 'NUMERIC', CURRENT_TIMESTAMP),
    ('feat_vol_term_spread_short', 'volatility_trend_short', 'Momentum & Technical', 'calc_volatility_surface_features',
    ...
    ('feat_vol_term_spread_long', 'volatility_trend_long', 'Momentum & Technical', 'calc_volatility_surface_features',
    ...
    -- EFFICIENCY RATIOS
    ('feat_asset_turnover', 'asset_turnover', 'Efficiency', 'calc_efficiency_ratios', 'Asset turnover ratio',
     ARRAY ['Total Revenues (LTM)', 'Total Assets (LTM)'], 'Total Revenues (LTM)', 'ratio', 'NUMERIC',
     CURRENT_TIMESTAMP),
    ('feat_inventory_turnover', 'inventory_turnover', 'Efficiency', 'calc_efficiency_ratios',
     'Inventory turnover ratio', ARRAY ['Cost Of Revenues (LTM)', 'Inventory (LTM)'], 'Cost Of Revenues (LTM)', 'ratio',
     'NUMERIC', CURRENT_TIMESTAMP),
    ('feat_receivables_days', 'receivables_days', 'Efficiency', 'calc_efficiency_ratios',
    ...
    ('feat_working_capital_turns', 'working_capital_turns', 'Efficiency', 'calc_efficiency_ratios',
    ...
    -- LONG TERM MOMENTUM
    ('feat_price_momentum_3y', 'price_momentum_3y', 'Momentum & Technical', 'calc_long_term_momentum_features',
     '3-year price momentum', ARRAY ['Last Price', 'Price (3Y Ago)'], 'Last Price', 'growth', 'NUMERIC',
     CURRENT_TIMESTAMP),
    ('feat_price_momentum_5y', 'price_momentum_5y', 'Momentum & Technical', 'calc_long_term_momentum_features',
     '5-year price momentum', ARRAY ['Last Price', 'Price (5Y Ago)'], 'Last Price', 'growth', 'NUMERIC',
     CURRENT_TIMESTAMP),
    ('feat_long_term_trend_score', 'long_term_trend_score', 'Momentum & Technical', 'calc_long_term_momentum_features',
    ...
    ('feat_multi_year_high_flag', 'multi_year_high_flag', 'Momentum & Technical', 'calc_long_term_momentum_features',
     'Near multi-year high flag', ARRAY ['52W High/Adj', 'Last Price', 'Price (3Y Ago)'], 'Last Price', 'flag',
     'INTEGER', CURRENT_TIMESTAMP),
    ('feat_secular_trend_flag', 'secular_trend_flag', 'Momentum & Technical', 'calc_long_term_momentum_features',
    ...
    ('feat_eps_cont_yoy_growth', 'eps_cont_yoy_growth', 'Earnings Quality', 'calc_eps_continuing_features',
     'Eps Cont Yoy Growth',
     NULL, NULL, 'growth', 'NUMERIC', CURRENT_TIMESTAMP),
    -- ENHANCED CASH FLOW (calc_enhanced_cashflow_features)
    ('feat_acquisition_pause_flag', 'acquisition_pause_flag', 'Enhanced Cash Flow', 'calc_enhanced_cashflow_features',
     'Acquisition Pause Flag',
     NULL, NULL, 'flag', 'INTEGER', CURRENT_TIMESTAMP),
    ('feat_acquisition_to_fcf', 'acquisition_to_fcf', 'Enhanced Cash Flow', 'calc_enhanced_cashflow_features',
     'Acquisition To Fcf',
     NULL, NULL, 'ratio', 'NUMERIC', CURRENT_TIMESTAMP),
    ('feat_acquisitions_ltm_total', 'acquisitions_ltm_total', 'Enhanced Cash Flow', 'calc_enhanced_cashflow_features',
     'Acquisitions Ltm Total',
     NULL, NULL, 'direct', 'NUMERIC', CURRENT_TIMESTAMP),
    ('feat_acquisitions_vs_5y_avg', 'acquisitions_vs_5y_avg', 'Enhanced Cash Flow', 'calc_enhanced_cashflow_features',
     'Acquisitions Vs 5y Avg',
     NULL, NULL, 'direct', 'NUMERIC', CURRENT_TIMESTAMP),
    ('feat_acquisitions_yoy_growth', 'acquisitions_yoy_growth', 'Enhanced Cash Flow', 'calc_enhanced_cashflow_features',
     'Acquisitions Yoy Growth',
     NULL, NULL, 'growth', 'NUMERIC', CURRENT_TIMESTAMP),
    ('feat_capex_3y_trend', 'capex_3y_trend', 'Enhanced Cash Flow', 'calc_enhanced_cashflow_features', 'Capex 3y Trend',
     NULL, NULL, 'growth', 'NUMERIC', CURRENT_TIMESTAMP),
    ('feat_capex_acceleration', 'capex_acceleration', 'Enhanced Cash Flow', 'calc_enhanced_cashflow_features',
     'Capex Acceleration',
     NULL, NULL, 'growth', 'NUMERIC', CURRENT_TIMESTAMP),
    ('feat_capex_cut_flag', 'capex_cut_flag', 'Enhanced Cash Flow', 'calc_enhanced_cashflow_features', 'Capex Cut Flag',
     NULL, NULL, 'flag', 'INTEGER', CURRENT_TIMESTAMP),
    ('feat_capex_qoq_growth', 'capex_qoq_growth', 'Enhanced Cash Flow', 'calc_enhanced_cashflow_features',
     'Capex Qoq Growth',
     NULL, NULL, 'growth', 'NUMERIC', CURRENT_TIMESTAMP),
    ('feat_capex_volatility', 'capex_volatility', 'Enhanced Cash Flow', 'calc_enhanced_cashflow_features',
     'Capex Volatility',
     NULL, NULL, 'direct', 'NUMERIC', CURRENT_TIMESTAMP),
    ('feat_capex_vs_5y_avg', 'capex_vs_5y_avg', 'Enhanced Cash Flow', 'calc_enhanced_cashflow_features',
     'Capex Vs 5y Avg',
     NULL, NULL, 'direct', 'NUMERIC', CURRENT_TIMESTAMP),
    ('feat_capex_yoy_growth', 'capex_yoy_growth', 'Enhanced Cash Flow', 'calc_enhanced_cashflow_features',
     'Capex Yoy Growth',
     NULL, NULL, 'growth', 'NUMERIC', CURRENT_TIMESTAMP),
    ('feat_cash_flow_quality_score', 'cash_flow_quality_score', 'Enhanced Cash Flow', 'calc_enhanced_cashflow_features',
     'Cash Flow Quality Score',
     NULL, NULL, 'score', 'NUMERIC', CURRENT_TIMESTAMP),
    ('feat_cff_share_of_cf', 'cff_share_of_cf', 'Enhanced Cash Flow', 'calc_enhanced_cashflow_features',
     'Cff Share Of Cf',
     NULL, NULL, 'ratio', 'NUMERIC', CURRENT_TIMESTAMP),
    ('feat_cfi_share_of_cf', 'cfi_share_of_cf', 'Enhanced Cash Flow', 'calc_enhanced_cashflow_features',
     'Cfi Share Of Cf',
     NULL, NULL, 'ratio', 'NUMERIC', CURRENT_TIMESTAMP),
    ('feat_cfo_share_of_cf', 'cfo_share_of_cf', 'Enhanced Cash Flow', 'calc_enhanced_cashflow_features',
     'Cfo Share Of Cf',
     NULL, NULL, 'ratio', 'NUMERIC', CURRENT_TIMESTAMP),
    ('feat_fcf_4q_improvement', 'fcf_4q_improvement', 'Enhanced Cash Flow', 'calc_enhanced_cashflow_features',
     'Fcf 4q Improvement',
     NULL, NULL, 'direct', 'NUMERIC', CURRENT_TIMESTAMP),
    ('feat_fcf_always_positive', 'fcf_always_positive', 'Enhanced Cash Flow', 'calc_enhanced_cashflow_features',
     'Fcf Always Positive',
     NULL, NULL, 'direct', 'NUMERIC', CURRENT_TIMESTAMP),
    ('feat_fcf_positive_years', 'fcf_positive_years', 'Enhanced Cash Flow', 'calc_enhanced_cashflow_features',
     'Fcf Positive Years',
     NULL, NULL, 'direct', 'NUMERIC', CURRENT_TIMESTAMP),
    ('feat_investment_efficiency', 'investment_efficiency', 'Enhanced Cash Flow', 'calc_enhanced_cashflow_features',
     'Investment Efficiency',
     NULL, NULL, 'direct', 'NUMERIC', CURRENT_TIMESTAMP),
    ('feat_ma_intensity_score', 'ma_intensity_score', 'Enhanced Cash Flow', 'calc_enhanced_cashflow_features',
     'Ma Intensity Score',
     NULL, NULL, 'score', 'NUMERIC', CURRENT_TIMESTAMP),
    ('feat_organic_vs_inorganic', 'organic_vs_inorganic', 'Enhanced Cash Flow', 'calc_enhanced_cashflow_features',
     'Organic Vs Inorganic',
     NULL, NULL, 'direct', 'NUMERIC', CURRENT_TIMESTAMP),
    ('feat_overinvestment_flag', 'overinvestment_flag', 'Enhanced Cash Flow', 'calc_enhanced_cashflow_features',
     'Overinvestment Flag',
     NULL, NULL, 'flag', 'INTEGER', CURRENT_TIMESTAMP),
    ('feat_self_funding_flag', 'self_funding_flag', 'Enhanced Cash Flow', 'calc_enhanced_cashflow_features',
     'Self Funding Flag',
     NULL, NULL, 'flag', 'INTEGER', CURRENT_TIMESTAMP),
    ('feat_serial_acquirer_flag', 'serial_acquirer_flag', 'Enhanced Cash Flow', 'calc_enhanced_cashflow_features',
     'Serial Acquirer Flag',
     NULL, NULL, 'flag', 'INTEGER', CURRENT_TIMESTAMP),
    ('feat_sustainable_ma_flag', 'sustainable_ma_flag', 'Enhanced Cash Flow', 'calc_enhanced_cashflow_features',
     'Sustainable Ma Flag',
     NULL, NULL, 'flag', 'INTEGER', CURRENT_TIMESTAMP),
    ('feat_total_investment_to_cfo', 'total_investment_to_cfo', 'Enhanced Cash Flow', 'calc_enhanced_cashflow_features',
     'Total Investment To Cfo',
     NULL, NULL, 'ratio', 'NUMERIC', CURRENT_TIMESTAMP),
    ('feat_underinvestment_flag', 'underinvestment_flag', 'Enhanced Cash Flow', 'calc_enhanced_cashflow_features',
